...
class GoogleCloudVMfromMarketplace(object):
    def __init__(self, name):
        """
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Google Cloud Provider.Google Cloud VM from Marketplace'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :type context: cloudshell.shell.core.driver_context.ResourceCommandContext
        :return:
        :rtype Google Cloud VM from Marketplace
        """
        result = GoogleCloudVMfromMarketplace(name=context.resource.name)
        for attr in context.resource.attributes:
            result.attributes[attr] = context.resource.attributes[attr]
        return result
    ...
    def cloudshell_model_name(self):
        ...
        :return:
        """
        return 'Google Cloud VM from Marketplace'
    ...
    def autoload(self):
        ...
        :rtype: bool
        """
        return self.attributes['Google Cloud Provider.Google Cloud VM from Marketplace.Autoload'] if 'Google Cloud Provider.Google Cloud VM from Marketplace.Autoload' in self.attributes else None
    ...
    def autoload(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Google Cloud Provider.Google Cloud VM from Marketplace.Autoload'] = value
    ...
    def wait_for_ip(self):
        ...
        :rtype: bool
        """
        return self.attributes['Google Cloud Provider.Google Cloud VM from Marketplace.Wait for IP'] if 'Google Cloud Provider.Google Cloud VM from Marketplace.Wait for IP' in self.attributes else None
    ...
    def wait_for_ip(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Google Cloud Provider.Google Cloud VM from Marketplace.Wait for IP'] = value
